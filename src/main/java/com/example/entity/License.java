...
public class License {
    ...
    public String toString() {
        return "License{" + "id=" + id + ", fileAttach=" + fileAttach + ", license=" + license + ", version=" + version + ", dateChanged=" + dateChanged + ", changedBy=" + changedBy + ", contentReset=" + contentReset + ", commentAttach=" + commentAttach + '}';
    }
